var printedProps = [];
var rownum = 0;
var err0, err1, err2, err3, err5, err6, err7, err8, err9, err10, err11, err12, err13;
...
function logicalSymbol(root) {
  ...
  switch (root.value) {
  case CONNECTIVE.NEGATION.value:
    symbol = Unot;
    break;
  case CONNECTIVE.CONJUNCTION.value:
    symbol = Uand;
    break;
  case CONNECTIVE.DISJUNCTION.value:
    symbol = Uor;
    break;
  case CONNECTIVE.IMPLICATION.value:
    symbol = Urarr;
    break;
  case CONNECTIVE.BICONDITIONAL.value:
    symbol = Uharr;
    break;
  case CONNECTIVE.THUS.value:
    symbol = Uthus;
    break;
  default:
    symbol = root.name;
